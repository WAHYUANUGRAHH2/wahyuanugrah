...
// koneksi database
$db = mysqli_connect('localhost', 'root', '', 'crudphpwahyua');
...
function tambah($data)
{
    ...
    $query = "INSERT INTO pengunjung VALUES 
            ('', '$nama', '$no_handphone', '$jenis_kelamin', '$email', '$gambar')";
...
{
    global $db;
    mysqli_query($db, "DELETE FROM pengunjung WHERE id = $id");
